...
void trace_unfriendly(int size, int range){
        
        FILE* fp = fopen("trace_unfriendly.txt","w");
...
int main(){
        ...
        trace_unfriendly(ADDRESSES, RANGE);
